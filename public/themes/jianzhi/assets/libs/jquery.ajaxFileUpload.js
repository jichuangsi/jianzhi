jQuery.extend({
    ...
    createUploadForm: function (id, fileElementId, data, header) {
        // create form
        ...
        if (header) {
            for (var i in header)
                $('<input type="hidden" name="' + i + '" value="' + header[i] + '" />').appendTo(form);
        }
    ...
    ajaxFileUpload: function (s) {
        ...
        var form = jQuery.createUploadForm(id, s.fileElementId, s.data, s.header);// 添加传入参数 s.data
