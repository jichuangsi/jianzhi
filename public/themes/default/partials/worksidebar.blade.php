<div class="accordion-style1 panel-group accordion-style2 g-side1" id="accordion">
    <div class="panel panel-default">
        <div class="panel-heading">
            <h4 class="panel-title clearfix">
                ...
                {{ (preg_match('/^\/user\/(acceptTasksList|serviceMyJob|workComment)/',$_SERVER['REQUEST_URI']))?'g-active':'' }}">
        ...
        <div id="collapseThree4" class="panel-collapse collapse {{ (preg_match('/^\/user\/(acceptTasksList|serviceMyJob|workComment)/',$_SERVER['REQUEST_URI']))?'in':'' }}">
    ...
    <div class="panel panel-default">
        ...
        {{ (preg_match('/^\/user\/(switchUrl|shop|myShopSuccessCase|goodsShop|serviceList|serviceEdit|serviceCreate|serviceBounty|shopcommentowner|waitGoodsHandle|pubGoods|editGoods|addShopSuccess|editShopSuccess|enterpriseAuth|waitServiceHandle)/',$_SERVER['REQUEST_URI']))?'in':'' }}">
