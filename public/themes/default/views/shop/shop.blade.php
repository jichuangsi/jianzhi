            ...
            <div class="personal-info-block">
                <div class="personal-info-block-name">
                    ...
                    <label class="open-close-space-btn shop-mainlabel">
                        <input name="switch-field-1" id="gritter-center" class="ace ace-switch" type="checkbox" {!! ($shopInfo['status']==1)?'checked':'' !!} shop_status="{!! $shopInfo['status'] !!}" shop_id="{!! $shopInfo['id'] !!}" {{--onchange="switchStatus($(this))"--}}>
                        <span class="lbl"></span>
                    </label>
                </div>
