                ...
                <label class="clearfix inline">
                    ...
                    <span class="lbl ">
                        <span  class="lbl-bank">
                            ...
                            <div class="text-center clearfix">{!! CommonClass::starReplace($item->alipay_account, 3) !!}</div>
                        </span>
                    </span>
                </label>
                    @endforeach
            ...
            <label class="clearfix inline">
                ...
                <span class="lbl ">
                    <span  class="lbl-bank">
                        ...
                        <div class="text-center clearfix">{!! $item->realname !!}       {!! CommonClass::starReplace($item->bank_account, 3) !!}</div>
                    </span>
                </span>
            </label>
                @endif
