        ...
        <table class="table table-hover text-size14 cor-gray51 table638">
            ...
            @if(!empty($list))
                ...
                <tr>
                    ...
                    <td class="cor-green">@if(in_array($item->action, array(2, 3, 7, 8,9,10,11))) + @else - @endif{!! $item->cash !!}</td>
                ...
                @if(!empty($list))
                    @foreach($list as $item)
                        <tr>
                            ...
                            <td class="cor-green">@if(in_array($item->action, array(2, 3, 7, 8))) + @else - @endif{!! $item->cash !!}</td>
                            <td>{!! $item->created_at !!}</td>
                        </tr>
                    @endforeach
                    @else
