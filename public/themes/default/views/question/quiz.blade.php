...
<div class="col-xs-12 col-left">
    <div class=" alert clearfix bg-white b-border quiz">
        ...
        <form class="" role="form" action="add" method="post">
...
<div class="col-xs-12 col-left">
    <div class="taskDetails taskbg clearfix taskSuccess employ-bounty">
        ...
        <div class="taskSuccess-right col-lg-7 col-md-9 col-sm-10 col-xs-12">
            ...
            <p class=""> 如长时间未通过审核，请立即<a target="_blank" href="javascript:;">联系管理员</a></p>
            <p><a href="" target="_blank">继续提问</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="" target="_blank">我的提问</a></p>
        </div>
    </div>
</div>
{{--发布失败--}}
...
<div class="col-xs-12 col-left">
    <div class="taskDetails taskbg clearfix taskSuccess employ-bounty">
        ...
        <div class="taskSuccess-right col-lg-7 col-md-9 col-sm-10 col-xs-12">
            ...
            <p class=""> 如有疑问，请立即<a target="_blank" href="javascript:;">联系管理员</a></p>
            <p><a href="" target="_blank">继续提问</a>或返回<a href="" target="_blank">我的提问</a></p>
        </div>
    </div>
</div>
@endif
