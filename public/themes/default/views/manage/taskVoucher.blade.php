...
<h3 class="header smaller lighter blue mg-top12 mg-bottom20">任务详情</h3>
    <form class="form-horizontal registerform" id="voucherform" role="form" action="{!! url('manage/taskVoucher') !!}" method="post" enctype="multipart/form-data">
    	{!! csrf_field() !!}
		<div class="g-backrealdetails clearfix bor-border">
	            <div class="form-group interface-bottom col-xs-12">
	                                              ...
	                                              <input type="hidden" name="tuid" value="{{$task['uid']}}" />
			...
			<div class="col-xs-12">
				<div class="clearfix row bg-backf5 padding20 mg-margin12">
					<div class="col-xs-12">
						...
						<div class="col-md-10">
							<div class="btn btn-primary btn-sm" style="margin-left: 50px" onclick="sub()">提交</div>
