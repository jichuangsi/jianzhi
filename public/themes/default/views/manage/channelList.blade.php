            	...
            	<div class="col-xs-4 " id="">
					...
					<div class="btn-group dropup">
						...
						<ul class="dropdown-menu">
							<li><a href="/manage/channelList?paginate=10">10</a></li>
							<li><a href="/manage/channelList?paginate=20">20</a></li>
							<li><a href="/manage/channelList?paginate=30">30</a></li>
							<li><a href="/manage/channelList?paginate=50">50</a></li>
						</ul>
					</div>
					条
                </div>
