...
<div class="row">
    <div class="col-md-12">
        ...
        <form class="form-horizontal registerform" role="form" action="{!! url('manage/taskAdd') !!}" method="post" enctype="multipart/form-data" onsubmit="return validate()">
            {!! csrf_field() !!}
            ...
            <div class="form-group basic-form-bottom" >
                ...
                <div class="col-sm-4">
                	<input style="margin: 10px;" type="file" name="file" id="file"  />
                	<input style="margin: 10px;" type="file" name="file2" id="file2"  />
                	<input style="margin: 10px;" type="file" name="file3" id="file3"  />
...
//  });
    function validate(){
		...
		var today = new Date()
		console.log($('input[name="begin_at"]').val());
