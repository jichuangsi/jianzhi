                    ...
                    @if(empty($childrenCate) && !empty($category))
                        ...
                        @foreach($childrenCate as $key => $val)
                            <div class="panel panel-default">
                                ...
                                <div @if($key == 0)id="collapseOne" aria-labelledby="headingOne"
                                     @elseif($key == 1)id="collapseTwo" aria-labelledby="headingTwo"
                                     @elseif($key == 2)id="collapseThree" aria-labelledby="headingThree"
                                     @elseif($key == 3)id="collapseFour" aria-labelledby="headingFour" @endif
