                ...
                <div class="news-main-area-wrap">
                    <ul class="news-title-list nav news-title-list-background">
                        @foreach($category as $v)
                            <li class="news-title-list-item @if($catID == $v->id  ) news-title-active @endif  "><a href="{!! URL('article?catID='.$v->id) !!}">{{ $v['cate_name'] }}</a> </li>
                        @endforeach
                    </ul>
                </div>
                ...
                <div class="release-form">
                    ...
                    <div class="input-group">
                        ...
                        <select class="form-control" id="form-field-select-1">
                            <option value="">悬赏任务</option>
                            <option value="AL">悬赏任务</option>
                            <option value="AK">悬赏任务</option>
                            <option value="AZ">悬赏任务</option>
                            <option value="AR">悬赏任务</option>
                            <option value="CA">悬赏任务</option>
                            <option value="CO">悬赏任务</option>
                            <option value="CT">悬赏任务</option>
                        </select>
                    ...
                    <div class="input-group">
                        ...
                        <input class="form-control input-mask-phone" type="text" id="form-field-mask-2" placeholder="需求标题,如:logo设计">
                    </div>
                    ...
                    <div class="input-group">
                        ...
                        <input class="form-control input-mask-phone" type="text" id="form-field-mask-2" placeholder="手机号码">
                    </div>

                    <div class="conmit-demand">
                        <button class="btn btn-primary conmit-demand-btn bor-radius2 btn-blue">发布需求</button>
                    </div>
