    ...
    <form class="registerform" action="{!! url('user/bankAuth') !!}" method="post">
        ...
        <ul class="xstxtleft">
            <li><div class="row task-casehid">
                ...
                <div class="col-md-2 col-sm-3 col-xs-3 text-right h5">开户行名称</div>
                <div class="col-md-10 col-xs-9"><input type="text" nullmsg="请输入开户行名称！" name="depositName" class="col-sm-3 inputxt col-xs-12" datatype="zh4-20" errormsg="请输入4到20位中文字符"  />
                    <span class="col-md-8 Validform_checktip vilid-wrprg"><i class="fa fa-exclamation-circle cor-orange text-size18"></i> 须使用以"法定代表人名称"为银行开户名</>
                </div>
                <div class="space-2 col-md-12"></div>
            </div></li>
            <li><div class="row task-casehid">
                <div class="space-8"></div>
                <div class="col-md-2 col-sm-3 col-xs-3 text-right h5">开户银行</div>
