                                    ...
                                    <div class="form-group step-validform" >
                                        ...
                                        <div class="col-xs-12 col-lg-8 col-md-9 col-sm-10">
                                            <div class="clearfix block ">
                                                <input type="text" name="email" id="email" class=" forminput  inputxt col-sm-5 col-xs-12" placeholder="请出入您的邮箱" datatype="e" ajaxurl="{!! url('password/checkEmail') !!}" nullmsg="请输入您的邮箱" errormsg="邮箱地址格式不对！">
