        ...
        <div class="tab-content clearfix f-tab">
                ...
                <form method="post" action="{{url('user/serviceBountyPay')}}">
                    ...
                    @if($balance >= $service_cash)
                        ...
                        <div class="text-center clearfix">
                            ...
                            <a href="javascript:history.back();void(0)" class="cor-gray93 btn-big">返回</a>
                        </div>
                        @else
                                <!--余额不足状态-->
                        <div class="text-size14 cor-gray51">
                            ...
                            <a href="javascript:history.back();void(0)" class="btn btn-white bor-radius2">返回</a>
                            <br>
                        </div>
                    @endif
                </form>
            ...
            <div class="tab-pane clearfix" id="home2">
                ...
                <div class="text-center clearfix">
                    ...
                    <a href="javascript:history.go(-1)" class="cor-gray93 btn-big">返回</a>
                </div>
                <div class="space"></div>
            </div>
        </div>
