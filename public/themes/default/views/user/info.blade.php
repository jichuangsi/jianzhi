<div class="g-main clearfix">
    ...
    <div class="col-xs-12 nopd768">
            ...
            <div class="form-group s-formwrp1 task-casehid">
                ...
                <div class="space-6 visible-xs-block"></div>
                <div class="col-sm-5">
                    <input type="text" class="form-control inputxt"  name="mobile" id="inputNumber" value="{{ $uinfo['mobile']?$uinfo['mobile']:'' }}" placeholder="请填写手机号" datatype="m|empty"  errormsg="手机号格式错误！">
                    {!! $errors->first('mobile') !!}
                </div>
                <div class="col-sm-2">
