...
class InformationController extends IndexController
{
    ...
    public function  index(Request $request)
    {
        ...
        if($request->get('catID')){
            ...
            $name = ArticleCategoryModel::where('id',$request->get('catID'))->first()->cate_name;
        ...
        if(!empty($upIDCate)){
            ...
            $list = ArticleModel::where('cat_id',$catID)->orderby('created_at','desc')->orderby('display_order','ASC')->paginate(10)->toArray();
